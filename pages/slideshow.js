      ...
      <Frame loggedIn={loggedIn}>
        ...
        <div className='wrapper'>
          ...
          <div className='optionsContainer'>
            ...
            <Input
              inline={false}
              label={'Tipo de slideshow'}
              type={'select'}
              choices={[
                { id: 'normal', label: 'Normal' },
                { id: 'roll', label: 'Rolante' },

              ]}
              name={'slideshowType'}
              value={slideshow.slideshowType}
              onChange={this.handleChange}
            />
            {slideshow.slideshowType != 'normal' && (
              <>
                <Input
                  disabled={slideshow.slideshowType == 'normal'}
                  inline={false}
                  ...
                  name={'speedRoll'}
                  value={slideshow.speedRoll}
                  onChange={this.handleChange}
                />
                <Input
                  disabled={slideshow.slideshowType == 'normal'}
                  inline={false}
                  label={'Direção de rolagem'}
                  type={'select'}
                  choices={[
                    { id: 'right', label: 'Para direita' },
                    { id: 'left', label: 'Para esquerda' },

                  ]}
                  name={'directionRoll'}
                  value={slideshow.directionRoll}
                  onChange={this.handleChange}
                />
              </>
            )
