...
import { faTrash, faEdit, faPlay, faGlobe, faTv } from '@fortawesome/free-solid-svg-icons'

import SlideEditDialog from './MultiDisplayEditDialog'
    ...
    return (
      <div className='cardSlide'>
        ...
        <div className='left'>
          ...
          >
            <FontAwesomeIcon icon={faTv} fixedWidth size='lg' color='#FFFFFF' />
          </div>
        </div>
