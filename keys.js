...
const dotenv = process.env.NODE_ENV !== 'HEROKU' ? require('dotenv').config() : { parsed: {} }
...
const ENVIRON = process.env.ENVIRON || dotenv.parsed.ENVIRON || process.env.NODE_ENV || 'DEV'
const MONGODB_URI =
...
const HOST_URL = process.env.SERVER_HOST || dotenv.parsed.SERVER_HOST || 'https://localhost:3000/'
